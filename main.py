...
def main():
    ...
    try:
        ...
        if args.sample:
            ...
            print("This is the forst statement in the main file: debug error")
            # main.py
        '''
        import subprocess

        # Print a debug statement before running the scripts
    
        print("This is the first statement in the main file: debug error")

        # Run guidance_classifier_finetune.py as a separate process
        subprocess.run(["python", "/home/iotlab/Desktop/CARD-MAIN/classification/guidance_classifier_finetune.py"])

        # Run guidance_resnet50.py as a separate process

        print("Script have been executed from main.py.")
        '''
        runner.train()
        procedure = "Training"
        end_time = time.time()
